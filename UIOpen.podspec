...
Pod::Spec.new do |s|
  s.name             = 'UIOpen'
  s.version          = '0.1.0'
  s.summary          = 'A short description of UIOpen.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/ntkien2192/UIOpen'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'ntkien2192' => 'ntkien2192@gmail.com' }
  s.source           = { :git => 'https://github.com/ntkien2192/UIOpen.git', :tag => s.version.to_s }
